...
export const metadata: Metadata = {
  title: {
    default:
      'Smart Cards - A next generation way of using the apps on your mobile phone ',
    template: '%s - Tailwind CSS',
  },
  description:
    'Smart cards are AI first,  utility first , functional design first app for all your day to activites ',
};
